...
namespace Ushahidi\App\DataProvider\Email;
...
class Email extends DataProvider {
	...
	public function send($to, $message, $title = "")
	{
		...
		try
		{
			...
			return array(DataProvider\Message\Status::SENT, $tracking_id);
		}
		catch (Exception $e)
		{
  ...
  protected function _is_provider_available()
  {
	...
	protected function _process_incoming($overview, $message)
	{
		...
		{
			// Save the message
			$this->receive(DataProvider\Message\Type::EMAIL, $from, $message, $to, $title, $data_provider_message_id);
		}
