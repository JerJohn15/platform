...
class Controller_Sms_Smssync extends Controller {
	...
	private function _incoming()
	{
		...
		$this->_provider->receive(DataProvider\Message\Type::SMS, $from, $message_text, $to);
	...
	private function _task()
	{
		...
		$messages = $this->_provider->get_pending_messages(20, DataProvider\Message\Status::PENDING_POLL, DataProvider\Message\Status::UNKNOWN);
