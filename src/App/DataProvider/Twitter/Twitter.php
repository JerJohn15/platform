...
namespace Ushahidi\App\DataProvider\Twitter;
...
class Twitter extends DataProvider {
	...
	public function fetch($limit = FALSE) {
		...
		try
		{
			...
			foreach ($statuses as $status) {
				...
				$this->receive(DataProvider\Message\Type::TWITTER, $screen_name, $text, $to = NULL, $title = NULL, $id, $additional_data);
	...
	public function send($to, $message, $title='')
	{
		...
		try
		{
			...
			return array(DataProvider\Message\Status::SENT, $response->id);
		}
		catch (TwitterOAuthException $toe)
		{
			return array(DataProvider\Message\Status::FAILED, FALSE);
