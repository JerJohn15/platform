...
namespace Ushahidi\App\DataProvider;
...
abstract class DataProvider {
	 ...
	 * @return  ORM
	 */
	public static function factory($provider_name = NULL, $type = DataProvider\Message\Type::SMS)
	{
	 ...
	 */
	abstract public function get_pending_messages($limit = FALSE, $current_status = DataProvider\Message\Status::PENDING_POLL, $new_status = DataProvider\Message\Status::UNKNOWN);
