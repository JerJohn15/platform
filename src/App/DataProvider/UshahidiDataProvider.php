...
abstract class UshahidiDataProvider extends DataProvider {
	 ...
	 */
	public function get_pending_messages($limit = FALSE, $current_status = Message\Status::PENDING_POLL, $new_status = Message\Status::UNKNOWN)
	{
